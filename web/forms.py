...
from .models import Profile, ThreadModel, User , Post, Comment, Gender, Hobby, MessageModel
...
class UserUpdateForm(forms.ModelForm):
    ...
    age = forms.CharField(required=False,max_length=10,widget=forms.TextInput(attrs={'class':'form-control','type':'text',}))
    class Meta:
        model = User
