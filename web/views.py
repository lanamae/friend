...
from .forms import  MessageForm, NewUserForm, ThreadForm, UserUpdateForm, ProfileUpdateForm
...
from .forms import UserCreationForm, PostForm, CommentForm, ThreadForm, MessageForm, ShareForm, ContactForm,ContactForm_Report
